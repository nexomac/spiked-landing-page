<script>
	...
	import { 
		Sparkles, Layers, FileText, Calendar, BarChart3, Target, CheckCircle2, RefreshCw,
		Clock, Brain, TrendingUp, Activity, ChevronRight
	} from 'lucide-svelte';
	import { 
		upcomingMeetings, briefingItems, contextHistory, actionItems, sessions 
	...
	let displayUpcomingMeetings = $derived(customUpcomingMeetings || upcomingMeetings);
	...
	// Icon mapping
	const iconMap = {
		FileText, Target, MessageSquare: FileText, CheckCircle2
	};
...
>
	...
	<div class="animated-border rounded-2xl overflow-hidden depth-shadow">
		...
		<div class="bg-gradient-to-br from-zinc-950 to-zinc-900 p-1 relative overflow-hidden">
			...
			<div class="grid grid-cols-[280px_1fr] relative z-10" style="min-height: {height};">
