	...
	const navData = {
		platform: {
			...
			links: [
				{
					title: "Cognitive Hub",
					desc: "Real-time AI assistance, contextual answers, and in-call intelligence.",
					icon: Cpu,
					href: "/features/ai-assistance",
				},
				{
					title: "Knowledge Hub",
					desc: "Personalized knowledge, document-based answers, and AI-tuned insights.",
					icon: Shield,
					href: "/features/custom-goals",
				},
				{
					title: "Customer Hub",
					desc: "Unified customer profiles, CRM intelligence, and readiness signals.",
					icon: User,
					href: "/features/crm",
				},
				{
					title: "Conversation Hub",
					desc: "Live conversation analysis, templates, and automated follow-ups.",
					icon: Sparkles,
					href: "/features/notetaker",
				},
				{
					title: "Enterprise Hub",
					desc: "Bi-directional CRM sync and workflow integrations across teams.",
					icon: Target,
					href: "/features/followup",
				},
				{
					title: "Learning Hub",
					desc: "Sales simulations, coaching, and conversational intelligence.",
					icon: Book,
		...
		solutions: {
			...
			links: [
				...
				{
					title: "Revenue Execution Engine",
					desc: "From conversation to action with zero operational drag.",
					icon: Terminal,
					href: "/features/followup",
				},
			],
