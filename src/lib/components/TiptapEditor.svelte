...
<div class="border border-gray-700 rounded-lg overflow-hidden bg-gray-950">
	<div
		class="bg-gray-900 border-b border-gray-800 p-2 flex gap-1 overflow-x-auto flex-wrap"
	>
		{#if editor}
			<button
				type="button"
				onclick={() => editor.chain().focus().toggleBold().run()}
				class="w-10 h-8 flex items-center justify-center rounded hover:bg-gray-800 {editor.isActive(
					'bold',
				)
			...
			<button
				...
				class="px-2 h-8 flex items-center justify-center rounded hover:bg-gray-800 {editor.isActive(
					'heading',
					{ level: 2 },
				)
					? 'bg-red-600 text-white'
			...
			<button
				...
				class="px-2 h-8 flex items-center justify-center rounded hover:bg-gray-800 text-gray-400"
			...
			<button
				...
				class="w-10 h-8 flex items-center justify-center rounded hover:bg-gray-800 text-gray-400"
				title="Undo">↶</button
			>
			<button
				type="button"
