...
<svelte:head>
	...
	<meta
		name="description"
		content="Explore all SpikedAI features - AI Assistance, Smart Notetaker, CRM Integration, and more."
	/>
</svelte:head>
...
>
	...
	<section class="relative pt-40 pb-20">
		<div class="absolute inset-0 overflow-hidden pointer-events-none">
			<div
				class="absolute top-1/4 -left-48 w-96 h-96 bg-red-600/20 rounded-full blur-3xl animate-pulse"
			></div>
			<div
				class="absolute bottom-1/4 -right-48 w-96 h-96 bg-red-500/20 rounded-full blur-3xl animate-pulse"
		...
		<div class="max-w-7xl mx-auto px-6">
			<div class="text-center mb-12">
				...
				<p class="text-lg text-muted-foreground">
					Quick access to detailed information about each feature
				</p>
			</div>
	...
	<section class="relative pb-70 pt-50 bg-background overflow-hidden">
		...
		<div class="relative max-w-4xl mx-auto px-6 text-center">
			...
			<p class="text-xl text-muted-foreground mb-8">
				Transform your sales process with SpikedAI today.
			</p>
			<button
