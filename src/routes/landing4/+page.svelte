		...
		>
			<div class="max-w-[1700px] mx-auto space-y-16">
				...
				<div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
					<!-- Visual Side -->
					<div
						class="lg:col-span-8 relative group overflow-hidden rounded-[3rem] bg-zinc-900 aspect-video lg:aspect-auto"
					>
						<img
						...
						/>
						<div
							class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent p-12 flex flex-col justify-end"
						>
							<div class="max-w-2xl">
								<div
				...
				>
					{#each showcases as showcase, i}
						{#if currentShowcaseIndex === i}
							...
							>
								<div
									class="w-full h-full p-4 md:p-8 flex items-center justify-center bg-zinc-50/5 dark:bg-zinc-900/50 overflow-hidden"
								>
